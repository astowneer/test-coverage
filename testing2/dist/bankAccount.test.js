...
describe("BankAccount", () => {
    describe("Initialization", () => {
        ...
        it('should return "Initial balance cannot be negative." when initialized with a negative balance', () => {
            expect(() => new bankAccount_1.BankAccount(-50)).toThrow("Initial balance cannot be negative.");
        });
    });
    describe("Deposits", () => {
    ...
    describe("Withdrawals", () => {
        ...
        it('should return "Withdrawal amount must be positive." when attempting to withdraw a negative amount', () => {
            const account = new bankAccount_1.BankAccount(100);
            expect(() => account.withdraw(-20)).toThrow("Withdrawal amount must be positive.");
        });
